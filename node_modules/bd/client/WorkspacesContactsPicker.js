...
var Picker = declare( [ EditableList ], {
    ...
    _setFilters: function(){
      ...
      //collection = collection.sort( 'contactId.id');
      //collection = collection.sort( 'contactId.id' ).sort( 'contactId.__position' );
      //collection = collection.sort( [ { property: 'contactId.id' }, { property: '__position' } ] );
