...
, WorkspacesContactsPhoneNumbers
  ...
  return declare( [ widgets.DestroyableTemplatedContainer ], {
    ...
    templateString: '' +
      ...
      '  <div data-dojo-type="hotplate/bd/WorkspacesContacts/WorkspacesContactsInfo" data-dojo-props="workspaceId: this.workspaceId, contactId: this.contactId", data-dojo-attach-point="workspacesContactsInfoWidget"></div>\n'+
    ...
    postCreate: function(){
      ...
      on( self.workspacesContactsInfoWidget.domNode, 'gotrecordid', function( e ){

        // Create the sub-widgets and start it up
        self.workspacesContactsEmailsWidget = new WorkspacesContactsEmails({
          workspaceId: self.workspaceId, contactId: self.workspacesContactsInfoWidget.recordId 
    ...
    startup: function(){
      ...
      if( self.workspacesContactsInfoWidget.recordId ){
        on.emit( self.workspacesContactsInfoWidget.domNode, 'gotrecordid', { bubble: false } );
      }
