...
, stores
  ...
  return declare( [ widgets.DestroyableTemplatedContainer ], {
    ...
    startup: function(){
      ...
      var tmp = stores( 'workspacesContactsEmails2', { workspaceId: '537e80c50d31f2c214ebedf3', contactId: self.workspacesContactsInfoWidget.recordId  })
      tmp.filter({}).fetch().then( function( r ) { console.log( r ) } );
