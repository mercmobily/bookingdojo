...
, StatsUsesSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    '        <label for="${id}_smtpSystemName">Name for automatic emails</label>\n' +
    '        <input id="${id}_smtpSystemName" name="smtpSystemName" data-dojo-type="dijit/form/ValidationTextBox" size="30" maxlength="70" data-dojo-props="required:false" />\n' +
    '      </div>\n' +

    '      <div class="inputField">\n' +
    '        <label for="${id}_smtpSystemEmail">From email address</label>\n' +
    '        <input id="${id}_smtpSystemEmail" name="smtpSystemEmail" data-dojo-type="dijit/form/ValidationTextBox" size="40" maxlength="255" data-dojo-props="required:false" />\n' +
    '      </div>\n' +
