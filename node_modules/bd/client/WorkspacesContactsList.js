...
INPUT: 
  * workspaceId
DESCRIPTION
An editable list of contacts. It allows filtering. It also provides an editing button for each contact (directing to `bd/WorkspacesContacts` and, on double clicking on a contact, it opens a new tab to see all details about a contact, as well as all messages exchanged with them via `/bd/WorkspacesContactsView`)
*/
define([
  "dojo/_base/declare"
, "dojo/aspect"
...
, WorkspacesContactsView
  ...
  return declare( [ EditableList ], {
    ...
    // Prepare the parameters for this type of widgets
    ...
    xConstructorParameters: function( type, recordId ){
      return {
        ...
        contactId: ( type === 'editing' ? recordId : null )
      };
    },
    ...
    postCreate: function(){
      ...
      self.own( 
        ...
        self.extraWidget.buttonWidget.on( 'click', function( e ){
          self.addingWidgetConstructorInDialog( 'New contact' );
        }),
        ...
        */
        ...
        self.store.on( 'add,update,delete', function( item ){
