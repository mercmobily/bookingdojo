...
* contactId 
DESCRIPTION
An editable list of addresses (`workspacesContactsAddresses`) owned by contactId.  
*/
define([
  "dojo/_base/declare"
...
, BusyButton
  ...
  var templateString = '' +
    ...
    '      <input class="field street-textarea" id="${id}_street" name="street" data-dojo-type="dijit/form/Textarea" cols="25"/>\n' +
    '    </div>\n' +
  ...
  return declare( [ EditableList ], {
    ...
    ownClass: 'workspaces-contacts-addresses',
    ...
    ExtraWidgetConstructor: declare( [ widgets.DestroyableTemplatedContainer ], {
      templateString: '' +
        ...
        '  <div data-dojo-attach-point="buttonWidget" class="new-address" data-dojo-type="hotplate/hotClientDojo/widgets/BusyButton" label="New address..." />\n' +
        '</div>\n'+
        '',
    }),
    ...
    postCreate: function(){
      ...
      self.extraWidget.buttonWidget.on( 'click', function( e ){
        self.addingWidgetConstructorInDialog( 'New address' );
      });
    },
