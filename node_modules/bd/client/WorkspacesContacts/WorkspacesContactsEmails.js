...
, globals
  ...
  return declare( [ EditableList ], {
    ...
    // Sets the `store` variable depending on the passed contactId
    constructor: function( p ){
      this.store = stores( 'WorkspacesContactsEmails', { workspaceId: globals.workspaceId, contactId: p.contactId } );
    },
    ...
    storeName: 'WorkspaceContactsEmails',
