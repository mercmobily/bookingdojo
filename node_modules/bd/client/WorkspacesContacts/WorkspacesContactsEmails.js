...
, globals
  ...
  var templateString = '' +
    ...
    '      <input id="${id}_email" name="email" data-dojo-type="dijit/form/ValidationTextBox" maxlength="70" data-dojo-props="placeHolder:\'Type a valid email address...\', validator: sharedValidators.email, invalidMessage:sharedValidators.email(false), required: true" data-dojo-attach-point="emailWidget" />\n' +
