...
* contactId 
DESCRIPTION
An editable list of email addresses (`workspacesContactsEmails`) owned by contactId.  
*/
define([
  "dojo/_base/declare"
...
, globals
  ...
  var templateString = '' +
    ...
    '      <input id="${id}_email" name="email" data-dojo-type="hotplate/hotClientDojo/widgets/SharedValidationTextBox" maxlength="70" data-dojo-props="placeHolder:\'Type a valid email address...\', sharedValidator: \'email\', required: true" data-dojo-attach-point="emailWidget" />\n' +
  ...
  return declare( [ EditableList ], {
    ...
    ownClass: 'workspaces-contacts-emails',
