...
, globals
  ...
  var templateString = '' +
    ...
    '      <input class="dial-code" id="${id}_dialCode" name="dialCode" data-dojo-type="dijit/form/ValidationTextBox" maxlength="4" data-dojo-props="placeHolder:\'61\', required: true, validator: sharedValidators.dialCode, invalidMessage: sharedValidators.dialCode(false)" data-dojo-attach-point="dialCodeWidget" />\n' +
