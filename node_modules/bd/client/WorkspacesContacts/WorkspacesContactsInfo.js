...
, WorkspacesContactsCategoriesSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    templateString: '' +
      ...
      '        <input class="input" id="${id}_dateOfBirth" name="dateOfBirth" data-dojo-type="hotplate/hotDojoWidgets/UTCDateTextBox" data-dojo-attach-point="dateOfBirthWidget" tabindex="4" />\n' +
      '      </div>\n' +
      ...
      '        <div id="${id}_contactCategory" name="contactCategory" data-dojo-type="hotplate/bd/WorkspacesContacts/WorkspacesContactsCategoriesSelect"></div>\n'+
      '      </div>\n' +
      ...
      // * contactCategory is deleted if selfEditing
      manipulateValuesBeforeSubmit: function( values ){
        ...
        if( this.selfEditing ) delete values.contactCategory;
      ...
      postCreate: function(){
        ...
        self.contactCategoryFieldOriginalStyle = domStyle.get( this.contactCategory, 'display' );
