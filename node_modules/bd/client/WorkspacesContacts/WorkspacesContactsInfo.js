...
, WorkspacesContactsCategoriesSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    templateString: '' +
      ...
      '        <div id="${id}_contactCategory" name="contactCategory" data-dojo-type="hotplate/bd/WorkspacesContacts/WorkspacesContactsCategoriesSelect" data-dojo-props="initialFilter: {  enabled: true }"></div>\n'+
      '      </div>\n' +
