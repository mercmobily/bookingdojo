...
, globals
  ...
  var templateString = '' +
    ...
    '      <input id="${id}_thing" name="thing" data-dojo-type="dijit/form/ValidationTextBox" maxlength="70" data-dojo-props="required: true" data-dojo-attach-point="thingWidget" />\n' +
  ...
  return declare( [ EditableList ], {
    ...
    ListConstructor: declare( [ commonMixins.FullOnDemandList ], {
      ...
      renderRow: function(object, options){
        var row = put('div.row', object.thing );
        return row;
      },
    ...
    postCreate: function(){
      ...
      console.log("OK, storeParameters are: ", this.storeName, this.storeParameters );
