...
define([
  ...
  declare('hotplate/bd/AdminWorkspaceSettings', [ EditingWidget ], {
    ...
    store: stores('workspaceConfig', { workspaceId: globals.workspaceId }),
    recordId: vars['hotCoreStoreConfig']['configStoreRecords'].workspaceConfig._id
    // defaultValues: { longName: "Stocazzo" },
