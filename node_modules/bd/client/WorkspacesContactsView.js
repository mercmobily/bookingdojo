...
, "hotplate/bd/WorkspacesContactsView/WorkspacesContactsMessages"
...
, stores
  ...
  return declare( [ widgets.DestroyableTemplatedContainer ], {
    ...
    templateString: '' +
      ...
      '      <div data-dojo-attach-point="WorkspacesContactsMessagesNode"></div>\n'+
      '      <div data-dojo-type="hotplate/hotDojoWidgets/Dummy"></div>\n'+
      '    </div>\n' +
      '  </div>\n' +
      '</div>\n' +
    ...
    postCreate: function(){
      ...
      // grid's info
      self.WorkspacesContactsMessages = new WorkspacesContactsMessages( { 
        contactObject: self.contactObject,
      }, self.WorkspacesContactsMessagesNode );

      self.WorkspacesContactsMessages.startup();
