...
, WorkspacesNinjaFormStatus
  ...
  return declare( [ widgets.DestroyableTemplatedContainer ], {
    ...
    templateString: '' +
      ...
      '      <p class="boxTitle">Latenza server</p>\n' +
      ...
      '  <div class="box" style="height: 30em">\n'+
      '    <p class="boxTitle">Contenuto</p>\n' +
      '    <iframe id="ninja-form-iframe" class="ninja-form-contents"></iframe>\n' +
      '  </div>\n'+
