      ...
      templateString: '' +
        ...
        */
        postCreate:function(){
          ...
          // Check is here for debugging purposes
          if( typeof( ConfigVars.userConfig ) === 'undefined' ){
            var name = 'USER';
          } else {
             var name = ConfigVars.userConfig.name;
          }
          self.userName.innerHTML = escapeHTML( name );

          topic.subscribe( 'configChange/userConfig', function( record ){
            self.userName.innerHTML = escapeHTML( record.name );
          });     
