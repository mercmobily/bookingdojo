   ...
   // "app/widgets/SearchPage",
    ...
    return declare( [ DestroyableJadeTemplatedContainer, _OverlayMixin, _OnDijitClickMixin, _TabRegisterMixin ], {
      ...
      templateString: '' +
        ...
        '      div(data-dojo-attach-point="workspacesUsersConfig",data-dojo-type="hotplate/bd/WorkspacesUsersConfig",data-dojo-props="title: \'Your Config\'")\n' +
        '      div(data-dojo-attach-point="workspacesConfig",data-dojo-type="hotplate/bd/WorkspacesConfig",data-dojo-props="title: \'Admin\'")\n' +
        '',
