   ...
   // "app/widgets/SearchPage",
    ...
    //return declare( [ ContentPane, _TemplatedMixin, _WidgetsInTemplateMixin, _TemplatedHooksMixin, _OverlayMixin, _OnDijitClickMixin ], {
      ...
      templateString: '' +
        ...
        '       <span>Booking Dojo</span> <span data-dojo-attach-event="onclick:testRun">TestRun</span> <span data-dojo-attach-point="userName" style="cursor:pointer" data-dojo-attach-event="ondijitclick:showUserConfig"></span>' +
        '    </div>' +
        ...
        */
        postCreate:function(){
          ...
          // possible changes
          that.userName.innerHTML = escapeHTML( ConfigVars.userConfig.name );
          topic.subscribe( 'configChange/userConfig', function( u ){
            that.userName.innerHTML = escapeHTML( ConfigVars.userConfig.name );
          });     
