...
, WorkspacesContacts
  ...
  return declare( [ widgets.DestroyableTemplatedContainer, _OverlayMixin, _OnDijitClickMixin, _TabRegisterMixin,_ReLoginMixin ], {
    ...
    templateString: '' +
      ...
      '      <span id="user-name" data-dojo-attach-point="userName"></span>\n' +
      ...
      '        <div data-dojo-type="hotplate/bd/WorkspacesContactsList" data-dojo-props="title:\'Search\'"></div>\n' + 
      '    </div>\n' +
    ...
    postCreate: function(){
      ...
      // Place the user's name at the top, using an auto-updating viewing widget
      var userTopBox = new UserTopBox({
        info: {
          workspacesContacts: {
            loadOnShow: false,
            data: vars.bd.userContact,
            id: vars.bd.userContact.id,
            store: stores('workspacesContacts', { workspaceId: globals.workspaceId } ),
          },
        }
      });
      userTopBox.placeAt( self.userName );
    ...
    _selfContactInfo: function(){
      ...
      var initialContactInfo = vars.bd.userContact;
