...
, "hotplate/hotClientDojo/auth/_ReLoginMixin"
...
, WorkspacesContacts
  ...
  return declare( [ widgets.DestroyableTemplatedContainer, _OverlayMixin, _OnDijitClickMixin, _TabRegisterMixin,_ReLoginMixin ], {
    ...
    templateString: '' +
      ...
      '      <span id="user-name" data-dojo-type="hotplate/bd/UserTopBox" data-dojo-props="contactId: this.loggedinUserContact.id, workspaceId: this.workspaceId"></span>\n' +
      
      '      <span id="rubbish" data-dojo-attach-point="rubbish">RUBBISH</span><span id="rubbish" data-dojo-attach-point="unRubbish">UNRUBBISH</span>\n' +
      ...
      '      <div id="contacts-tab" data-dojo-attach-point="contactsTab" data-dojo-type="dijit/layout/TabContainer" data-dojo-props="title:\'Contacts\', region: \'center\', tabPosition: \'top\'">\n' +
      '        <div data-dojo-type="hotplate/bd/WorkspacesContactsList" data-dojo-props="workspaceId: this.workspaceId, title:\'Search\'"></div>\n' + 
      '    </div>\n' +

      '      <div data-dojo-type="hotplate/bd/Inbox" data-dojo-props="title:\'Inbox\', workspaceId: this.workspaceId" class="inbox"></div>\n' +
      ...
      '      <div data-dojo-type="hotplate/bd/WorkspacesUsersConfig" data-dojo-props="title: \'Your Config\', workspaceId: this.workspaceId, contactId: this.loggedinUserContact.id, userId: this.loggedinUserContact.userId" ></div>\n' +
      '      <div data-dojo-type="hotplate/bd/WorkspacesConfig" data-dojo-props="title: \'Admin\', workspaceId: this.workspaceId"></div>\n' +
    ...
    postCreate: function(){
      ...
      makeDndSource( self.rubbish, false );
      makeDndSource( self.unRubbish, true );

      function makeDndSource( node, setTo ){

        return new DnDSource(node, {

          // Make the rubbish bin
          accept: ["dgrid-row"],
          isSource: false,
          ...
          checkAcceptance: function(source, nodes){
            var withEnabledField = source.grid && source.grid.collection && source.grid.collection.enabledField;
            var withRightValue = true;
            return withEnabledField && withRightValue;
          },
    ...
    _selfContactInfo: function(){
      ...
      var initialContactInfo = this.loggedinUserContact;
      ...
      if( ! initialContactInfo.firstName ){
        ...
        var contactEditor = new WorkspacesContacts({
          ...
          contactId: initialContactInfo.id,
