...
, Contacts
  ...
  return declare( [ widgets.DestroyableTemplatedContainer, _OverlayMixin, _OnDijitClickMixin, _TabRegisterMixin ], {
    ...
    templateString: '' +
      ...
      '      <span data-dojo-attach-point="userName" style="cursor:pointer" data-dojo-attach-event="ondijitclick:showUserConfig"></span>\n' +
      '    </div>\n' +
      ...
      '      <div data-dojo-attach-point="inboxWidget" data-dojo-type="hotplate/bd/Inbox" data-dojo-props="title:\'Inbox\'" class="inbox"></div>\n' +
      ...
      '      <div data-dojo-attach-point="workspacesUsersConfig" data-dojo-type="hotplate/bd/WorkspacesUsersConfig" data-dojo-props="title: \'Your Config\'"></div>\n' +
      '      <div data-dojo-attach-point="workspacesConfig" data-dojo-type="hotplate/bd/WorkspacesConfig" data-dojo-props="title: \'Admin\'"></div>\n' +
      '    </div>\n' +
      '  </div>\n' +
      '</div>\n' +
      '',
