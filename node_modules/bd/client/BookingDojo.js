...
, WorkspacesContacts
  ...
  return declare( [ widgets.DestroyableTemplatedContainer, _OverlayMixin, _OnDijitClickMixin, _TabRegisterMixin,_ReLoginMixin ], {
    ...
    constructor: function(){
      this.data = {};
      this.data.workspaceId = globals.workspaceId;
      this.data.loggedinUserContact = vars.bd.userContact;
    },
    ...
    templateString: '' +
      ...
      '      <span id="user-name" data-dojo-type="hotplate/bd/UserTopBox" data-dojo-props="contactId: this.data.loggedinUserContact.id, workspaceId: this.data.workspaceId"></span>\n' +
      ...
      '        <div data-dojo-type="hotplate/bd/WorkspacesContactsList" data-dojo-props="workspaceId: this.data.workspaceId, title:\'Search\'"></div>\n' + 
      '    </div>\n' +

      '      <div data-dojo-type="hotplate/bd/Inbox" data-dojo-props="title:\'Inbox\', workspaceId: this.data.workspaceId" class="inbox"></div>\n' +
      ...
      '      <div data-dojo-type="hotplate/bd/WorkspacesUsersConfig" data-dojo-props="title: \'Your Config\', workspaceId: this.data.workspaceId, contactId: this.data.loggedinUserContact.id, userId: this.data.loggedinUserContact.userId" ></div>\n' +
      '      <div data-dojo-type="hotplate/bd/WorkspacesConfig" data-dojo-props="title: \'Admin\', workspaceId: this.data.workspaceId"></div>\n' +
          ...
          switch( storeName ){
            ...
            case 'workspacesContactsPhoneNumbers':
              ...
              store.on( 'add,update,delete', function( event ){
                ...
                //var emailStore = stores( 'workspacesContactsEmails', { workspaceId: event.target.workspaceId, contactId: event.target.contactId });
                ...
                if( contact[ mainFieldName ]!== first.id ){
    ...
    _selfContactInfo: function(){
      ...
      var initialContactInfo = this.data.loggedinUserContact;
