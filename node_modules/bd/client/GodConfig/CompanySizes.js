  ...
  return declare( [ EditableList ], {
    ...
    AddingConstructor: declare( [ EditingWidget ], {
      templateString: '' +
        ...
        '  <div class="inline-form">\n' +
        '    <form data-dojo-type="dijit/form/Form" data-dojo-attach-point="formWidget" method="POST">\n' +
        '      <input id="${id}_name" name="name" data-dojo-type="dijit/form/ValidationTextBox" maxlength="50" data-dojo-props="required:true, placeHolder:\'Type a company size here...\'" data-dojo-attach-point="nameWidget, focusNode" />\n' +
