  ...
  return declare( [ EditableList ], {
    ...
    ListConstructor: declare( [ commonMixins.FullOnDemandList ], {
      ...
      renderRow: function(object, options){
        ...
        put( row, 'span.ownedByWorkspaceId', object.ownedByWorkspaceId ? object.ownedByWorkspaceId : '' );
    ...
    ExtraWidgetConstructor: declare( [ widgets.DestroyableTemplatedContainer ], {
      templateString: '' +
        ...
        '  <span id="${id}_ownedByWorkspaceId" data-dojo-attach-point="ownedByWorkspaceIdWidget" data-dojo-type="dijit/form/TextBox" data-dojo-props="placeHolder:\'Workspace Id...\'"></span>\n' +
        ...
        //'  <span data-dojo-attach-point="updteFiltersButtonWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton" label="Filter"></span>\n' +
    ...
    EditingConstructor: declare([ EditingWidget ], {
      templateString: '' +
        ...
        '      <div class="inputField">\n' +
        '        <label for="${id}_ownedByWorkspaceId">Workspace owner</label>\n' +
        '        <input id="${id}_ownedByWorkspaceId" name="ownedByWorkspaceId" data-dojo-type="dijit/form/ValidationTextBox" size="40" maxlength="255" data-dojo-props="" />\n' +
        '      </div>\n' +
        ...
        resetOnSuccess: true,
         ...
         manipulateValuesBeforeSubmit: function( values ){
           if( values.ownedByWorkspaceId == '' ) delete values.ownedByWorkspaceId;
         },
    ...
    _setFiltersAndSort: function(){
      ...
      var ownedByWorkspaceId = self.extraWidget.ownedByWorkspaceIdWidget.get('value');
      if( ownedByWorkspaceId != '' ) collection = collection.filter( { ownedByWorkspaceId: ownedByWorkspaceId });
