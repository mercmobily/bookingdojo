...
define([
  ...
  var UsersCategoriesSelect =  declare( 'hotplate/bd/UserConfig/UsersCategoriesSelect', [ StoreSelect ], {
  ...
  return declare('hotplate/bd/UserConfig', [ _JadeTemplatedMixin, EditingWidget ], {
    ...
    templateString: '' +
      ...
      '      div( name="userCategory", data-dojo-type="hotplate/bd/UserConfig/UsersCategoriesSelect")\n'+
