...
, globals
  ...
  return declare( [ EditingWidget ], {
    ...
    '        <input id="${id}_clickDate" name="clickDate" data-dojo-type="hotplate/hotDojoWidgets/UTCDateTextBox" data-dojo-props="validator: this.dateValidator.bind(this)" data-dojo-attach-point="clickDateWidget" />\n' +
    '      </div>\n' +
    '      <div class="inputField">\n' +
    ...
    afterFormWidgetSet: function( res ){
      ...
      if( date ){
        ...
        console.log( this.clickTimeWidget.get('value' ) );
