...
, globals
  ...
  return declare( [ StoreRecordViewWidget ], {
    ...
    templateString: '' +
      '<div>\n' +
      '  <p>Differenza di orario: <span data-dojo-attach-point="timeOffset">Carico...</span></p>\n' +
      ' <input class="formSubmit" type="submit" data-dojo-attach-point="buttonWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton" label="Aggiorna" />\n' +
      '</div>\n' +
      '',
