          ...
          if( forms ){
            ...
            forms.forEach( function( form ){
              ...
              on( iframe, 'load', function(){
                ...
                var now = new Date();
                var deltaRequest = now - self.requestTime;
                var deltaChanged = now - self.changedTime;
                //var deltaClickDay = now - self.changedTime;
                logger( self.submitLabel, "Submission fatta per " + iframe.title + ", tempi (ms): " + deltaRequest + " (da richiesta), " + deltaChanged + " (da ricevimento form a ricezione risposta)" );
