...
, Dummy
  ...
  return declare([ EditingWidget ], {
    ...
    templateString: '' +
      ...
      '    <input id="${id}_body" name="body" data-dojo-type="hotplate/hotDojoWidgets/ValidationTextArea" data-dojo-props="required:true, validator: this.messageValidator" data-dojo-attach-point="bodyWidget" />\n' +
