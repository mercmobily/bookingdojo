...
, WorkspacesContactsPicker
  ...
  return declare( [ widgets.DestroyableTemplatedContainer ], {
    ...
    templateString: '' +
      '<div class="workspaces-contacts-cc-sms-container">\n' +
      '  <div class="workspaces-contacts-cc-sms">\n' +
    ...
    postMixInProperties: function(){
      ...
      if( this.defaultTo && this.defaultTo._children.mainPhoneNumberId ){
        this.initialTo = { contactObject: this.defaultTo, smsObject: this.defaultTo._children.mainPhoneNumberId };
      }
    ...
    resetTo: function(){
      ...
      if( self.initialTo ){
        self._addElement( self.initialTo.contactObject, self.initialTo.smsObject );
      }

    },

    _addElement: function( contactObject, smsObject ){

      var self = this;

      // Won't add the same element twice
      if( self._alreadyAddedHash[ smsObject.id ] ) return;
      self._alreadyAddedHash[ smsObject.id ] = 'single';

      var formattedName = contactObject.firstName + ' ' + contactObject.lastName + ' &lt;' + smsObject.number + '&gt;'
    ...
    postCreate: function(){
      ...
      self.own( 
        ...
        on( self.buttonWidget, 'click', function( e ){
          var workspacesContactsPicker = new WorkspacesContactsPicker( { type: 'PhoneNumbers' } );// PhoneNumbers
