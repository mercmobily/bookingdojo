...
, widgets
  ...
  return declare( [ EditableList ], {
    ...
    postMixInProperties: function(){
      ...
      this.initialFilter = this.contactObject  ? { contactId: this.contactObject.id } : {};

      this.addingConstructorParameter  = this.contactObject ? { contactObject: this.contactObject } : {};
      this.editingConstructorParameter = this.contactObject ? { contactObject: this.contactObject } : {};
