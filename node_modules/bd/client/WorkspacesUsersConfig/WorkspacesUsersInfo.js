...
, WorkspacesContactsEmailsSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    '      <div class="inputField">\n'+
    '        <label for="${id}_setting2">Setting 2</label>\n'+
    '        <input id="${id}_setting2" name="setting2" data-dojo-type="dijit/form/CheckBox" data-dojo-attach-point="setting2Widget" size="40" maxlength="80", required:true" />\n'+
    '      </div>\n' +
    ...
    afterFormWidgetSet: function( res ){
      if( res.setting2 ) this.setting2Widget.set('value', true );
    },

    manipulateValuesBeforeSubmit: function( values ){
      values.setting2 = values.setting2.indexOf( 'on' ) !== -1;
    },
