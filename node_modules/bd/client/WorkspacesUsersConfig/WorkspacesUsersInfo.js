...
, "hotplate/bd/WorkspacesContactsEmailsPicker"
...
, WorkspacesContactsEmailsPicker
  ...
  return declare( [ EditingWidget ], {
    ...
    '        <div class="notificationsEmailAddress" id="${id}_notificationsEmailAddress" name="notificationsEmailAddress" data-dojo-type="hotplate/bd/WorkspacesUsersConfig/WorkspacesContactsEmailsSelect" data-dojo-props="storeExtraParameters:{ contactId: vars.hotCoreStoreConfig.storeRecords.workspacesUsersInfo._children.workspacesContacts[0].id }"></div>\n' +
    '      </div>\n' +


    '      <input data-dojo-attach-point="testLookupWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton" label="Lookup Contact" />\n'+
    ...
    postCreate: function(){
      ...
      this.testLookupWidget.on('click', function( e ){
        workspacesContactsEmailsPicker = new WorkspacesContactsEmailsPicker();
        workspacesContactsEmailsPicker.startup();
        workspacesContactsEmailsPicker.show();
