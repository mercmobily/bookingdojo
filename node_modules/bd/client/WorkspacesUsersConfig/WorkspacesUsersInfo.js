...
, WorkspacesUsersCategoriesSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    '      </div>\n' +
    '      <div name="userCategory" data-dojo-type="hotplate/bd/WorkspacesUsersConfig/WorkspacesUsersCategoriesSelect"></div>\n'+
    ...
    store: stores( 'WorkspacesUsersInfo', { workspaceId: globals.workspaceId } ),
