  ...
  return declare( [ EditableList ], {
    ...
    AddingConstructor: declare( [ EditingWidget ], {
      templateString: '' +
        ...
        '        <input id="${id}_name" name="name" data-dojo-type="dijit/form/ValidationTextBox" maxlength="50" data-dojo-props="required:true, placeHolder:\'Type a goal here...\'" data-dojo-attach-point="nameWidget" />\n' +
        '        <input class="form-submit" type="submit" data-dojo-attach-point="buttonWidget" data-dojo-type="hotplate/hotDojoWidgets/BusyButton" label="Add" />\n' +
        '      </div>\n'+
        '    </form>\n'+
        '  </div>\n'+
        '</div>\n'+
    ...
    storeParameters: { workspaceId: globals.workspaceId, userId: globals.userId },
    //store: stores( 'WorkspacesUsersGoals', { workspaceId: globals.workspaceId, userId: globals.userId } ),
