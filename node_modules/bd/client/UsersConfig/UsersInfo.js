...
//, UsersCategoriesSelect
  ...
  return declare( [ EditingWidget ], {
    ...
    templateString: '' +
      ...
      '        <input id="${id}_name" name="name" data-dojo-type="dijit/form/ValidationTextBox" size="10" maxlength="40" />\n' + 
      '      </div>\n' +
      '      <div class="inputField">\n' +
      '        <label for="${id}_surname">Last Name</label>\n' +
      '        <input id="${id}_surname" name="surname" data-dojo-type="dijit/form/ValidationTextBox" size="40" maxlength="40" />\n' +
      '      </div>\n' +

      '      <div class="inputField">\n' +
      '        <label for="${id}_email">Email</label>\n' +
      '        <input id="${id}_email" name="email" data-dojo-type="dijit/form/ValidationTextBox" size="40" maxlength="80" name="email", data-dojo-props="validator:sharedFunctions.hotCoreCommonValidators.emailValidator, required:true, invalidMessage:sharedFunctions.hotCoreCommonValidators.emailValidator(false)" />\n' +
      '      </div>\n' +
