  ...
  hotCoreStoreRegistry.getAllStores( function( err, registryStores ){
    ...
    registryStores.workspacesUsersBase.redefineMethod( 'afterPost', function( request, doc, fullDoc, cb ){
      this.inheritedAsync( registryStores.workspacesUsersBase.afterPost, arguments, function(){
        registryStores.workspacesContacts.apiPost( { userId: doc.userId, workspaceId: doc.workspaceId }, {}, cb );
      });
    });
...
hotplate.hotEvents.on( 'stores', 'bd', hotplate.cachable( function( done ){
  ...
  hotCoreJsonRestStores.get( function( err, s ){
    ...
    var WorkspacesContactsCategories = declare( [ HotStore, MultiHomePermsMixin ], {
      ...
      checkPermissionsPutExistingg: function checkPermissionsPutExisting( request, doc, fullDoc, cb ){
        cb( null, false );
      },
    ...
    var WorkspacesContactsEmailsBase = declare( [ HotStore, MultiHomePermsMixin ],  {
      ...
      schema: new HotSchema({
        ...
        email      : { type: 'string', searchable: true, required: true, notEmpty: true, sharedValidator: 'email', trim: 70, min: 4 },
      }),
    ...
    var WorkspacesContactsEmailsSearch = declare( [ WorkspacesContactsEmailsBase ],  {
      ...
      afterGetQuery: function( request, queryDocs, done ){
    ...
    var WorkspacesContactsPhoneNumbersBase = declare( [ HotStore, MultiHomePermsMixin ],  {
      ...
      schema: new HotSchema({
        ...
        label     : { type: 'string', searchable: true, required: false, trim: 64 },
        dialCode  : { type: 'number', searchable: true, required: true, notEmpty: true, trim: 4, min: 1, sharedValidator: 'countryDialCode' },
   ...
   var WorkspacesContactsPhoneNumbersSearch = declare( [ WorkspacesContactsPhoneNumbersBase ],  {
    ...
    var MessagesTo = declare( [ HotStore ],  {
    ...
    var MessagesToDeliveryLog = declare( [ HotStore ],  {
    ...
    var WorkspacesMessages = declare( [ HotStore, MultiHomePermsMixin ],  {
      ...
      schema: new HotSchema({
        ...
        toContacts        : { type: 'string', required: true, doNotSave: true, notEmpty: true, trim: 16000 },
        type              : { type: 'string', required: true, doNotSave: true, notEmpty: true, trim: 5 },

        from              : { type: 'string', searchable: true, doNotSave: true, required: true, notEmpty: true, trim: 255 },        
        subject           : { type: 'string', searchable: true, doNotSave: true, required: true, notEmpty: false, trim: 1024 },
        body              : { type: 'string', searchable: true, doNotSave: true, required: true, notEmpty: true, trim: 256000 },
      ...
      onlineSearchSchema: new HotSchema({
        ...
        toContactId       : { type: 'id', searchOptions: [
          { field: 'workspacesMessagesToContacts.id', type: 'eq', condition: 'and'  },
        ]},
        contactId: { type: 'id', searchOptions: [
          { field: 'workspacesMessagesToContacts.id', type: 'eq', condition: 'or'  },
      ...
      nested: [
        {
          layer: 'workspacesMessagesToContacts',
          join: { 'messageId': 'id' },
          type: 'multiple'
        },
      ],
    ...
    var WorkspacesMessagesToContacts = declare( [ HotStore, MultiHomePermsMixin ],  {

      schema: new HotSchema({

        workspaceMessageId : { type: 'id', required: true },
        contactId          : { type: 'id', required: true },

        messagesToId       : { type: 'id', required: true },        
        messageId          : { type: 'id', required: true }, // NN
      }),

      onlineSearchSchema: new HotSchema({
      }),

      storeName:  'workspacesMessagesToContacts',

      publicURL: '/workspaces/:workspaceId/messages/:messageId/toContacts/:id',
      hotExpose: true,
    ...
    stores.workspacesMessagesToContacts = new WorkspacesMessagesToContacts();
