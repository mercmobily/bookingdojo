    ...
    if( err ){
      ...
      var WorkspacesNinjaFormSettings = declare( [ HotStore, MultiHomePermsMixin ],  {
        ...
        schema: new HotSchema({
          ...
          clicktime      : { type: 'date',   required: false },
        }),
          ...
          this.inheritedAsync( afterPutExisting, arguments, function( err ){
            ...
            if( docAfter.url == '' ){
              current = "Idle";
               ...
               current = "Ready to pounce";
            } else {
               current = "Waiting for date";
            }
      ...
      var WorkspacesNinjaFormTimeOffset = declare( [ HotStore, MultiHomePermsMixin ],  {
        ...
        prepareBody: function( request, body, method, cb ){
          ...
          // timeOffset is calculated, regardless of what's passed in the put
          setTimeout( function(){
            body.timeOffset = 700 + Math.floor( Math.random() * 100 );
            cb( null );
          }, 2000 );
