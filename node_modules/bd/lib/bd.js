  ...
  hotCoreJsonRestStores.get( function( err, s ){
    if( err ){
      ...
      stores.WorkspacesContacts = declare( [ HotStore, MultiHomePermsMixin ],  {
        ...
        // TODO: Implement this. Go through all refs, fetch them, place them in refField
        ref: {
          workspaceContactsIsStarred: {
            store: stores.WorkspacesContactsIsStarred,
            filter: function( doc ){ return { workspaceId: doc.workspaceId, id: doc.contactId } } ,
            limit: 1,
           ...
           workspaceContactsAddresses: {
            ...
            filter: function( doc ){ return { workspaceId: doc.workspaceId, contactId: doc.contactId } },
            assignLimit: 1,
            assignTotal: true,
          },
