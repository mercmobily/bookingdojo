...
hotplate.hotEvents.on('stores', 'bd', hotplate.cachable( function( done ){
  ...
  hotCoreJsonRestStores.get( function( err, s ){
    if( err ){
      ...
      stores.WorkspaceCategories = declare( [ HotStore, MultiHomePermsMixin ], {
      ...
      stores.UserCategories = declare( [ HotStore, MultiHomePermsMixin, PrivateUserDataMixin ], {
      ...
      stores.WorkspaceUserCategories = declare( [ HotStore, MultiHomePermsMixin, PrivateUserDataMixin ], {
      ...
      stores.UserConfig = declare( [ HotStore, MultiHomePermsMixin, PrivateUserDataMixin ], {
      ...
      stores.WorkspaceConfig = declare( [ HotStore, MultiHomePermsMixin ], {
      ...
      stores.WorkspaceUserConfig = declare( [ HotStore, MultiHomePermsMixin, PrivateUserDataMixin ], {
