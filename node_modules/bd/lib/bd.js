  ...
  hotCoreStoreRegistry.getAllStores( function( err, storeRegistry){
    ...
    switch( transport ){
      ...
      case 'sms-twilio':
        ...
        var provider = transport === 'sms-privio' ? 'plivo' : 'twilio';
        var result = [];

        if( provider == 'twilio' ){
            var s = storeRegistry.twilioConfig;
        } else if( provider == 'plivo') {
            var s = storeRegistry.twilioConfig; // TODO: add Plivo in GUI
        } else {
   ...
   var WorkspacesContactsPhoneNumbersSearch = declare( [ WorkspacesContactsPhoneNumbersBase ],  {
    ...
    var WorkspacesMessages = declare( [ HotStore, MultiHomePermsMixin ],  {
      ...
      schema: new HotSchema({
        ...
        messageId         : { type: 'id', required: false, protected: true, searchable: true, notEmpty: true },
    ...
    var TwilioConfig = declare( [ HotStore ], {
      ...
      publicURL: '/config/twilioConfig/:globalId',
      hotExpose: true,
    ...
    var WorkspacesEmailConfig = declare( [ HotStore, MultiHomePermsMixin ], {
      ...
      schema: new HotSchema({
        smtpSystemName  : { type: 'string', required: false, default: "Email system", notEmpty: true, trim: 70},
        smtpSystemEmail : { type: 'string', required: false, default: "youremail@example.com", sharedValidator: 'email', notEmpty: true, trim: 255},
