...
hotplate.hotEvents.on( 'stores', 'bd', hotplate.cachable( function( done ){
  ...
  hotCoreJsonRestStores.get( function( err, s ){
    if( err ){
      ...
      stores.Contacts = declare( [ HotStore, MultiHomePermsMixin ],  {
    
        schema: new HotSchema({
          firstName         : { type: 'string', required: true, notEmpty: true, trim: 50 },
          middleName        : { type: 'string', required: true, notEmpty: true, trim: 50 },
          lastName          : { type: 'string', required: true, notEmpty: true, trim: 50 },
          addressLine1      : { type: 'string', required: true, notEmpty: true, trim: 50 },
          addressLine2      : { type: 'string', required: true, notEmpty: true, trim: 50 },
          city              : { type: 'string', required: true, notEmpty: true, trim: 50 },
          state             : { type: 'string', required: true, notEmpty: true, trim: 50 },
          zip               : { type: 'string', required: true, notEmpty: true, trim: 50 },
          country           : { type: 'string', required: true, notEmpty: true, trim: 50 },
        }),
