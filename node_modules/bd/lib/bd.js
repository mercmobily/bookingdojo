    ...
    if( err ){
      ...
      stores.WorkspacesContactsAddresses = declare( [ HotStore, MultiHomePermsMixin ],  {
        ...
        schema: new HotSchema({
          ...
          addressLine1      : { type: 'string', required: false, trim: 50 },
          addressLine2      : { type: 'string', required: false, trim: 50 },
          city              : { type: 'string', required: false, trim: 50 },
          state             : { type: 'string', required: false, trim: 40 },
          zip               : { type: 'string', required: false, trim: 10 },
          country           : { type: 'string', required: false, trim: 60 },
        }),
