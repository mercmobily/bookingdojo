  ...
  hotCoreJsonRestStores.get( function( err, s ){
    ...
    var WorkspacesMessages = declare( [ HotStore, MultiHomePermsMixin ],  {
      ...
      schema: new HotSchema({
        ...
        // Took this out as it's still not in use
        ...
        //fromAsString        : { type: 'string', searchable: false, protected: true },
        //toAsString          : { type: 'string', searchable: false, protected: true },

        // DoNotSave fields (they are in hotCoreTransport's Messages)
